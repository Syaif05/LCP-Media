  ...
  return (
    <div className="space-y-6 fade-in min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end md:items-center gap-4 border-b border-slate-200 dark:border-white/5 pb-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-1">My Library</h1>
          <p className="text-sm text-slate-500 dark:text-zinc-400">
            You have <span className="font-bold text-orange-500">{courses.length}</span> courses in your collection.
          </p>
        </div>
