...
import { Download, X, HardDrive, CheckCircle, Loader2 } from 'lucide-react';
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm">
        ...
        >
          ...
          <div className="p-6 space-y-4">
            <div className="bg-slate-50 dark:bg-black/20 p-4 rounded-xl border border-slate-100 dark:border-white/5 flex items-start gap-4">
               ...
               <div className="flex-1 min-w-0">
                 ...
                 <p className="text-xs text-slate-500 dark:text-zinc-400 mt-1 break-all">Target: {fileInfo?.targetDir}</p>
               </div>
            </div>
          ...
          {progress?.percent === 100 && (
             <div className="absolute inset-0 bg-white/95 dark:bg-zinc-900/95 flex flex-col items-center justify-center text-center p-6 z-50">
                ...
                <button onClick={onClose} className="px-6 py-2 bg-slate-900 dark:bg-white text-white dark:text-black rounded-lg font-bold hover:opacity-90 transition-opacity">
                  Close
                </button>
             </div>
          )}
